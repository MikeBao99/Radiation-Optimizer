...
% Jack Greenberg - January 2013             %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% toggle true/false for whether to normalize beam intensity in visual
% use true by default
normalize = true;
...
% to visualize absolute intensities, set beammax to a constant
if (~normalize)
    beammax = 20; % this value looked the best
end
% normalize beam
